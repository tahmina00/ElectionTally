	...
	const RenderMenu = () => {
	  ...
	  <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
		 ...
		 <NavLink class="dropdown-item" to="/constitutionalldata">Constitution All data</NavLink>
        </div>
      </li>
	 ...
	 <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
		 ...
		 <NavLink class="dropdown-item" to="/candidateforbangla">Candidate For Bangla </NavLink>     
		 <NavLink class="dropdown-item" to="/candidatealldatalist">Candidate All data </NavLink>
        </div>
      </li>
